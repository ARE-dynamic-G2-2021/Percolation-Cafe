...
#Paramètres
nb_cellules= 50
repetitions= 100 #Attention: l'experience prend beaucoup de temps deja avec 100 repetitions!
...
def test(nb_cellules, densite, repetitions): #ici on calcule le rapport cafe extrait/densite des pores pour le nb de repetitions donné
  rendement = []
...
y = np.array(Y)
figure(figsize=(8, 6))
plt.plot(x, y, markersize = 3, color='red') #avec ou sans 'o'
plt.xlabel('Densité des Pores')
